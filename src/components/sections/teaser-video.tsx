      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 md:px-12 lg:px-40 py-8 sm:py-12 md:py-16">
        <div className="mb-4 sm:mb-6 md:mb-10">
          <motion.h3
            ...
            className="see-you-text font-power font-light text-lg sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl text-white normal-case tracking-normal mb-1 sm:mb-2 md:mb-4 text-center sm:text-left"
          >
            See you at
          </motion.h3>
          <motion.h2
