...
const Valedictory = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-background text-white py-12 px-4 md:py-20 md:px-10 lg:px-20 font-display">
      <div className="relative mb-16 md:mb-24">
        ...
        >
          ...
          <h2 className="text-secondary text-2xl md:text-5xl lg:text-[64px] font-black tracking-tighter uppercase leading-none">
            Valedictory
          </h2>
        </motion.div>
      ...
      <div ref={blastRef} className="mt-20 md:mt-32">
        ...
        >
          <h2 className="text-festival-green text-3xl md:text-6xl lg:text-[100px] font-black tracking-tighter uppercase leading-none">
            Blast
          </h2>
          <motion.svg
            animate={{ rotate: 360 }}
