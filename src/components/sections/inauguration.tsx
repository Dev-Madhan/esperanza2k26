...
const Inauguration = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-background py-12 px-4 md:py-20 md:px-10 lg:px-20 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 md:gap-12">
          ...
          >
            ...
            >
              <h2 className="font-power text-2xl md:text-5xl lg:text-7xl xl:text-[96px] text-festival-yellow leading-none tracking-tight text-center lg:text-left">
                INAUGURATION
              </h2>
              <motion.div
                animate={{ rotate: 360 }}
            ...
            <motion.h3
              ...
              className="font-power text-xl md:text-4xl lg:text-6xl text-festival-green leading-none mb-6 md:mb-8 text-center lg:text-left"
            >
              Rahul Chahar
            </motion.h3>
        ...
        <div ref={artistsRef} className="mt-20 md:mt-32">
          ...
          >
            ...
            <h2 className="font-power text-3xl md:text-6xl lg:text-8xl xl:text-[120px] text-festival-yellow text-center leading-none tracking-tighter">
              ARTISTS
            </h2>
            <motion.div
              animate={{ rotate: -360 }}
